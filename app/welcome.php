...
<div class="line-small" ><h1>Simple Manager</h1><h5>Employers</h5></div><br /><br />
</div>
<div class="container">
...
<?php 
echo "<h3>Nasza firma jest zdecydowanym liderem innowacyjności na rynku. Zatrudniamy obecnie " . $count[0] . " pracownikow itp. itd ...</h3></div>";
?>
<div class="col-md-6 col-sm-6 col-xs-12 line" >
<?php 
echo "<p class=\"text-right lead\">Jesli chcesz zostac jednym z nich zadzwoń pod 
<button class=\"btn btn-info btn-lg\">nr telefonu</button></p></div>
		<p class=\"test\" style=\"display: none\">666-666-666</p>";
?>
<div class="col-md-12 col-sm-6 col-xs-12">
<?php
echo "<p class=\"text-right lead\">Jesli jestes jednym z nich   <a href=\"$conf->app_url?action=goLogin\" >
